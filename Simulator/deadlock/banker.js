...
function addInitialRes(){
	...
	p1.setAttribute("style","margin-left:10px;float:left;margin-right:10px;padding-left:10px");
	...
	var p2=document.createElement("card");
		p2.setAttribute("style","margin-left:25px;float:left;margin-right:10px;padding-left:10px");
...
function displayneed(){
	...
	h.setAttribute("style", "margin: 20px 0px 0px 0px");
