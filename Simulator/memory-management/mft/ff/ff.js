...
function startColumn2() {
  ...
  <a style="text-decoration:none; color:white; font-size:1.26rem;" href="./ff.html"><button type="submit" class="btn btn-primary" id="rem-pro-btn">Reset</button></a>
  `;
  ...
  for (i = 0; i < num_parts; i++) {
    if (part_occupied[i] == 0 && found == 0) {
      if (pro_size <= part_size[i]) {
        ...
        // ctx.beginPath();
        // ctx.rect(myCanvas_x_start, part_myCanvas_start[i], myCanvas_width, part_size[i]*(500/mem_size));
        // ctx.fillStyle = "red";
        // ctx.fill();

        // ctx.beginPath();
        // ctx.rect(myCanvas_x_start, part_myCanvas_start[i], myCanvas_width, pro_size*(500/mem_size));
        // ctx.fillStyle = "green";
        // ctx.fill();

        // ctx.font = "14px Arial bold";
        // ctx.fillStyle = "black";
        // ctx.fillText("P-"+ String(pro_id), myCanvas_width/2, part_myCanvas_start[i] + pro_size*(500/mem_size)/2);
      }
    }
  }
  if (found == 0 && fromQ == 0) {
